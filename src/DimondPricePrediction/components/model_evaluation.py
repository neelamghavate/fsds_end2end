...
class ModelEvaluation:
    def __init__(self):
        logging.info("inside Model evaluation ")
        pass

    
    def eval_metrics(self,actual, pred):
        logging.info("inside eval_metrics ")
    ...
    def initiate_model_evaluation(self,train_array,test_array):
        logging.info("nside initiate_model_evaluation")
        ...
        try:
            ...
            mlflow.set_registry_uri("https://dagshub.com/neelamghavate/fsds_end2end.mlflow")
